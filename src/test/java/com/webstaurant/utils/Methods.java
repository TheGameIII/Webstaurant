...
public class Methods extends PageInitializer {
	 ...
	 * @throws NoAlertPresentExeption if alert is not present
	 */
	 ...
	 * @param nameOrId
	 * @throws NoSuchFrameException if there is no frame with that nameOrId
	 */
	 ...
	 * This method will switch to the frame
	 * @param element
	 * @throws NoSuchFrameException if there is no frame with that element
	 */
	...
	public static WebDriverWait getWaitObject() {
		WebDriverWait wait=new WebDriverWait(driver,Constants.EXPLICITI_LOAD_TIME);
		return wait;
	}
	/**
	...
	/**
	 * This method will select the given text among visible text within the given dropdown elements.
	 * @param element
	 * @param text
	 */
